...
return array(
    "table" => "dbresky_vkexporter",
    "table_data" => array(
        "NAME" => "DKIVKEXPORTER",
        "ERR" => "Ошибка при создании highloadblock'a dbresky_vkexporter",
        "LANGS" => array(
    ...
    "fields" => array(
        ...
        array(
            ...
            'ERROR_MESSAGE' => array(
                'ru' => 'Ошибка при заполнении поля "ID  подборки" ',
                'en' => 'An error in completing the field "Album id"',
            ),
            'HELP_MESSAGE' => array(
                'ru' => '',
                'en' => '',
