...
return array(
    ...
    "fields" => array(
        ...
        array(
            ...
            'ERROR_MESSAGE' => array(
                'ru' => 'Ошибка при заполнении поля "ID фото подборки в vk" ',
                'en' => 'An error in completing the field "Picture vk id"',
            ),
            'HELP_MESSAGE' => array(
                'ru' => '',
                'en' => '',
